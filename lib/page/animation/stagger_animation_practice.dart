      ...
      child: Material(
        child: Center(
          child: Container(
            ...
            //调用我们定义的交错动画Widget
            child: StaggerAnimationPractice(controller: _controller),
          ),
        ),
      ),
    );
...
class StaggerAnimationPractice extends StatelessWidget {
  final Animation<double> controller;
  Animation<double> height;
  Animation<EdgeInsets> padding;
  Animation<Color> color;

  StaggerAnimationPractice({Key key, this.controller}) : super(key: key) {
